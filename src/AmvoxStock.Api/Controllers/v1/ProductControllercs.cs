using AmvoxStock.Application.Common.Models;
using AmvoxStock.Application.Dtos.Product;
using AmvoxStock.Application.Interfaces;
using Microsoft.AspNetCore.Mvc;

namespace AmvoxStock.Api.Controllers.v1;
